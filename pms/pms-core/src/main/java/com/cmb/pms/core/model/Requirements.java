...
public class Requirements {
    ...
    private Date reqCreTime; // 记录生成时间

    private Date reqModTime; // 记录更新时间

    private String reqCreator; // 创建人

    private String reqModifier;  // 修改人
	...
	public Date getReqCreTime() {
		return reqCreTime;
	}

	public void setReqCreTime(Date reqCreTime) {
		this.reqCreTime = reqCreTime;
	}
	...
	public String getReqModifier() {
		return reqModifier;
	}

	public void setReqModifier(String reqModifier) {
