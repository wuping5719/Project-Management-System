...
<body>
	<div id="container">
		...
		<div id="main">
			...
			<div id="local">
		    <label style="margin-left:2%; margin-top: 1%;">当前位置: 事项追踪 >已解决</label>		
		    </div>
			<div id="panel">
				<div id="queryBar" style="text-align:left;">
					 ...
					 <button id="newEveTra" type="button" class="btn btn-default btn-sm" style="background-color:#a6d2ff;margin-left:2%">新建事项</button>
				</div>
	...
	<script>
     $(document).ready(function () {
         ...
         $.ajax({
             type : "POST",
             url : "<%=basePath%>searchFinishEventTracks.do?eveTraReqName=&eveTraState=&eveTraPerInCharge=&pageNum=1",
     ...
     $(".eveTraSkip").click(function(){
          ...
          if (this.id == "eveTraFirst") {   // 首页
             ...
             $.ajax({
                 type : "POST",
                 url : "<%=basePath%>searchFinishEventTracks.do?",
                 data:{
     ...
     var treeNodes = [
               ...
               {"id":2, "pId":0, "name":"已解决", "url":"<%=basePath%>loadEventTrackFinish.do" ,"target":"_self"}
     ];
	...
	<div id="dialog" title="新建事项" style="display: none;">
		<div id="eveTraInfo" style="margin: 3px 2px; border: 1px solid #617775; background: #f5f5f5; width: 100%; height: 100%;">
			<div >
				...
				<input id="newEveTraState" type="text" style="margin-top: 20px;margin-left: 39px; width: 550px;" value = "已解决" disabled/>	
	...
	<div id="dialogUpdate" title="更新事项" style="display: none;">
		<div id="eveTraInfo" style="margin: 3px 2px; border: 1px solid #617775; background: #f5f5f5; width: 100%; height: 100%;">
			<div >
				...
				<label style="margin-top: 20px; margin-bottom: 10px; margin-left: 20px; color: #696969;">状态  ：</label> 				
				<input id="updateEveTraState" type="text" style="margin-top: 20px;margin-left: 39px; width: 550px;" disabled/>	
				...
				<input id="updateEveTraPerInCharge" type="text" style="margin-top: 20px;margin-left: 30px;  width: 550px; " />
			</div>
		</div>
	</div>
    			...
    			click: function() {
    	            ...
    	            $.ajax({
    	                ...
    	                success: function () {
    	                	   ...
    	                	   window.location.href = "<%=basePath%>loadEventTrackFinish.do";
                        },
						error : function(e) {
    	   			...
    	   			click: function() {
    	   	            ...
    	   	            $.ajax({
    	   	                ...
    	   	                data:{
    	   	                	...
    	   	                	updateEveTraPerInCharge : updateEveTraPerInCharge, eveTraID : eveTraID
    	   	                },
    	   	                success: function () {
