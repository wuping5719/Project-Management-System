...
<body>
	<div id="container">
		...
		<div id="main">
			...
			<div id="local">
		           <label style="margin-left:2%; margin-top: 1%;">当前位置: 需求管理->预研需求</label>		
		    </div>
			<div id="panel">
				<div id="queryBar" style="text-align:left;">
					 ...
					 <label style="margin-top: 0.5%;">项目(任务)名称：</label>
				...
				<div id="reqsListTable">
					<table id="reqsTab">
						<tr style="font-weight: bold; background-color: #e1ebf5; text-align: center; height: 40px; ">
							...
							<td style="width: 80px">需求编号</td>
							<td style="width: 120px">项目(任务)名称</td>
							<td style="width: 80px">立项时间</td>
							<td style="width: 80px">计划结束时间</td>
							<td style="width: 80px">主/辅办</td>
							<td style="width: 80px">负责人</td>
							<td style="width: 80px">其他成员</td>
							<td style="width: 80px">目前状态</td>
							<td style="width: 80px">对口业务</td>
	...
	<script>
     $(document).ready(function () {
         ...
         $.ajax({
             type : "POST",
             url : "<%=basePath%>searchPreResReqs.do",
             ...
             success : function(msg) {
                 ...
                 $.each(msgRes.reqDTOsList,function(i,result){
                     if (i % 2 == 0){
                    	 reqsItem = "<tr style=\"background-color:#e0ffff\">\
				               <td >" + result.sortIndex + "</td>\
				               <td >" + result.reqNum + "</td>\
				               <td >" + result.reqName + "</td>\
				               <td >" + result.reqStartDate + "</td>\
				               <td >" + result.reqScheduleDate + "</td>\
				               <td >" + result.reqOrganizeType + "</td>\
				               <td >" + result.reqPerInCharge + "</td>\
				               <td >" + result.reqMember + "</td>\
                    	 ...
                    	 reqsItem = "<tr style=\"background-color:#f5f5f5\">\
                    		   <td >" + result.sortIndex + "</td>\
                    		   <td >" + result.reqNum + "</td>\
				               <td >" + result.reqName + "</td>\
				               <td >" + result.reqStartDate + "</td>\
