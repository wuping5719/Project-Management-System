...
<body>
	<div id="container">
		...
		<div id="main">
			...
			<div id="local">
		           <label style="margin-left:2%; margin-top: 1%;">当前位置: 需求管理->评估中需求</label>		
		    </div>
			<div id="panel">
				<div id="queryBar" style="text-align:left;">
					 <label style="margin-left: 2%; margin-top: 0.5%;">需求编号：</label> 
					 <input id="reqNum" type="text"  style="width: 120px; height: 24px; margin-top: 5px;" /> 
				...
				<div id="reqsListTable">
					<table id="reqsTab">
						<tr style="font-weight: bold; background-color: #e1ebf5; text-align: center; height: 40px; ">
							...
							<td style="width: 80px">主要内容</td>
							<td style="width: 80px">负责人</td>
							<td style="width: 80px">其他人员</td>
	...
	<script>
     $(document).ready(function () {
         ...
         $.ajax({
             type : "POST",
             url : "<%=basePath%>searchEstimatingReqs.do",
