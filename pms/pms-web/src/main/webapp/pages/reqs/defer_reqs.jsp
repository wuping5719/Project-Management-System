...
<body>
	<div id="container">
			...
			<div id="main_top">
				...
				<div class="hg_nav">
					...
					<div class="hg_sch">
						...
						<a id="a_logout" href="<%=basePath%>logout.do" onclick="">注销</a>
					</div>
				</div>
			</div>
		</div>
		<div id="main">
			...
			<div id="local">
		           <label style="margin-left:2%; margin-top: 1%;">当前位置: 需求管理->暂缓需求</label>		
		    </div>
			<div id="panel">
				...
				<div id="reqsListTable">
					<table id="reqsTab">
						<tr style="font-weight: bold; background-color: #e1ebf5; text-align: center; height: 40px; ">
							...
							<td style="width: 120px">需求名称</td>
							<td style="width: 80px">状态</td>
							<td style="width: 80px">优先级</td>
							<td style="width: 80px">排期</td>
							<td style="width: 80px">主要内容/评估结果</td>
	...
	<script>
     $(document).ready(function () {
         ...
         $.ajax({
             type : "POST",
             url : "<%=basePath%>searchDeferReqs.do",
                 ...
                 $.each(msgRes.reqDTOsList,function(i,result){
                     if (i % 2 == 0){
                    	 reqsItem = "<tr style=\"background-color:#e0ffff\">\
				               ...
				               <td >" + result.reqChildState + "</td>\
				               <td >" + result.reqPriority + "</td>\
